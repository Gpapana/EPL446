...
public class dbGUI extends JFrame {
	...
	public dbGUI(String TSdata[][], String[] columnNames) {
		...
		lblNewTransaction.setBounds(227, 303, 164, 14);
		...
		lblTransaction.setBounds(401, 303, 164, 14);
		...
		lblNewLabel_1.setBounds(502, 32, 164, 14);
		contentPane.add(lblNewLabel_1);

		JScrollPane scrollPane_2 = new JScrollPane();
		scrollPane_2.setBounds(460, 50, 253, 200);
